...
-- Attach the native drag interaction to a collection of item views.
function UIKit.attachReorder(container, children, onReorder)
...
--- @platform AppKit and UIKit.
function UIKit.TimelineView(props)
	props = props or {}
	local content = props.content or props[1]
