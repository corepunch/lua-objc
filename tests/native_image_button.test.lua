...
local path, pathRefs = xml.render('<VStack><Label ref="label" text="/Users/example/Library/Developer/CoreSimulator/Devices" size="11" fillWidth="true" lines="0" wrapping="character" /></VStack>', {}, ns)
