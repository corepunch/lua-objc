...
local sheet, refs = xml.render('<Sheet width="600" height="400"><VStack maxWidth="infinity" maxHeight="infinity"><Label text="Review"/><List id="list" flexGrow="1" maxWidth="infinity"><Column id="name"/></List><Button id="done" title="Done"/></VStack></Sheet>', {}, ns)
