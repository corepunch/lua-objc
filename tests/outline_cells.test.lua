...
refs.dynamic:add(xml.render('<Label text="New content" height="80"/>', {}, ns))
refs.dynamic:layout()
...
local wrapped = xml.render('<VStack><Label ref="label" text="Long native text must wrap at its final proposed width" lines="3" maxWidth="infinity" /></VStack>', {}, ns)
