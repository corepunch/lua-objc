...
local deleted
app.service.command(Simulators.runtimeCommand(runtimes[1]), function(ok) deleted = ok end)
t.expect(deleted, "the mock deletes a deletable runtime through simctl's command")
