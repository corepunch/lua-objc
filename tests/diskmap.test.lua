...
t.expect(ui.refs.openReclaim ~= nil and ui.refs.openReclaim.enabled, "suggested cleanups stay available from the category list")
local categoryRows = ui.refs.results.rowCount
ns._invokeAction(ui.refs.openReclaim)
