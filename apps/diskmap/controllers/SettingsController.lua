...
function Controller:presentation(toggle, openSettings, openPrivacySettings, mediaEnabled, media)
	return {monitoring = self.enabled, mediaEnabled = mediaEnabled == true,
		actions = {monitor = toggle, storage = openSettings, privacy = openPrivacySettings, media = media}}
end
return Controller
