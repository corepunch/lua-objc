...
function Tips.forInventory(model, disk)
	...
	if count > 0 then
		tips[#tips + 1] = {id = "kept", icon = "checkmark.shield", title = "Kept resources stay protected",
	...
	tips[#tips + 1] = {id = "system", icon = "shield.lefthalf.filled", title = "macOS manages system storage",
