local Model = require("apps.navigation-path.Model")
...
function Controller.new()
	...
	path:registerDestination("message", function(value)
		return xml.renderFile("apps/navigation-path/views/Message.etlua", {
			message = value,
		}, ns)
	end)
...
function Controller:createWindow()
	local config, refs = xml.renderFile("apps/navigation-path/views/Window.etlua", {
		path = self.path,
		destinations = {},
