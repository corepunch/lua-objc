...
local Model = require("apps.lazy-reorder.Model")
...
function Controller:createWindow()
	local root, refs = xml.renderFile("apps/lazy-reorder/views/Root.etlua",
		{ kind = self.kind }, ns)
	...
	self.content = Template.new(refs.host, "apps/lazy-reorder/views/" .. file, ns)
	self:render()
	return self.window
end
